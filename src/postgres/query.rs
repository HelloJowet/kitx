...
use sqlx::{
    Acquire, Error, FromRow, Postgres, QueryBuilder,
...
pub async fn execute<'a>(mut builder: QueryBuilder<'a, Postgres>) -> Result<PgQueryResult, Error> {
...
pub async fn execute_with_trans<'a>(builders: Vec<QueryBuilder<'a, Postgres>>) -> Result<Vec<PgQueryResult>, Error> {
    #[cfg(debug_assertions)]
    {
...
pub async fn fetch_optional<'a, T>(mut builder: QueryBuilder<'a, Postgres>) -> Result<Option<T>, Error>
where
...
pub async fn fetch_one<'a, T>(mut builder: QueryBuilder<'a, Postgres>) -> Result<T, Error>
where
    T: for<'r> FromRow<'r, PgRow> + Unpin + Send + 'a,
{
    #[cfg(debug_assertions)]
...
pub async fn fetch_all<'a, T>(mut builder: QueryBuilder<'a, Postgres>) -> Result<Vec<T>, Error>
where
    T: for<'r> FromRow<'r, PgRow> + Unpin + Send + 'a,
{
    #[cfg(debug_assertions)]
...
pub async fn fetch_scalar<'a>(mut builder: QueryBuilder<'a, Postgres>) -> Result<i64, Error> {
    #[cfg(debug_assertions)]
    {
        let sql = builder.sql();
        dbg!(sql);
...
pub async fn fetch_scalar_optional<'a>(mut builder: QueryBuilder<'a, Postgres>) -> Result<Option<i64>, Error> {
    #[cfg(debug_assertions)]
    {
        let sql = builder.sql();
        dbg!(sql);
