...
use sqlx::{
    Acquire, Error, FromRow, QueryBuilder, Sqlite,
...
pub async fn execute<'a>(mut builder: QueryBuilder<'a, Sqlite>) -> Result<SqliteQueryResult, Error> {
...
pub async fn execute_with_trans<'a>(builders: Vec<QueryBuilder<'a, Sqlite>>) -> Result<Vec<SqliteQueryResult>, Error> {
    #[cfg(debug_assertions)]
    {
...
pub async fn fetch_optional<'a, T>(mut builder: QueryBuilder<'a, Sqlite>) -> Result<Option<T>, Error>
where
...
pub async fn fetch_one<'a, T>(mut builder: QueryBuilder<'a, Sqlite>) -> Result<T, Error>
where
    T: for<'r> FromRow<'r, SqliteRow> + Unpin + Send + 'a,
{
    #[cfg(debug_assertions)]
...
pub async fn fetch_all<'a, T>(mut builder: QueryBuilder<'a, Sqlite>) -> Result<Vec<T>, Error>
where
    T: for<'r> FromRow<'r, SqliteRow> + Unpin + Send + 'a,
{
    #[cfg(debug_assertions)]
...
pub async fn fetch_scalar<'a>(mut builder: QueryBuilder<'a, Sqlite>) -> Result<i64, Error> {
    #[cfg(debug_assertions)]
    {
        let sql = builder.sql();
        dbg!(sql);
...
pub async fn fetch_scalar_optional<'a>(mut builder: QueryBuilder<'a, Sqlite>) -> Result<Option<i64>, Error> {
    #[cfg(debug_assertions)]
    {
        let sql = builder.sql();
        dbg!(sql);
